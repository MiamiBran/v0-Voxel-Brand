    ...
    <header data-section="TITLE">
      ...
      <div className="px-5 md:px-10 py-8 md:py-12">
        <div className="border border-border bg-card/60 backdrop-blur-sm max-w-4xl">
          ...
          <div className="border-b border-border flex flex-wrap text-[7px] md:text-[8px] font-mono text-muted-foreground/40 tracking-[0.15em]">
          ...
          <div className="flex flex-col md:flex-row md:items-stretch">
            ...
            <div className="flex-1 px-5 py-5 md:py-6 md:border-r md:border-border">
              ...
              <p className="text-[9px] md:text-[10px] font-mono text-muted-foreground/50 mt-2 tracking-[0.25em]">
            ...
            <div className="border-t md:border-t-0 border-border flex flex-col min-w-[180px]">
              {/* Index header */}
              <div className="border-b border-border px-4 py-1 text-[7px] font-mono text-muted-foreground/30 tracking-[0.2em]">
                INDEX
              </div>
              ...
              <nav className="flex md:flex-col flex-1">
                {[
                  ...
                  >
                    <span className="text-[7px] font-mono text-muted-foreground/25">{item.num}</span>
                    <span className="text-[9px] md:text-[10px] font-mono tracking-[0.15em] text-muted-foreground/60 group-hover:text-foreground transition-colors">
                      {item.label}
                    </span>
                  </button>
                ))}
              ...
              <div className="border-t border-border px-4 py-2 flex items-center gap-2">
                {[
                  ...
                  <div key={s.key} className="flex items-center gap-1">
                    <div className="w-2.5 h-2.5 border border-border/30" style={{ backgroundColor: s.color }} />
                    <span className="text-[6px] font-mono text-muted-foreground/25 hidden md:block">{s.key}</span>
                  </div>
                ))}
              </div>
            </div>
